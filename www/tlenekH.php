		...
		<div class="content">
			<div id="data">
				...
				try {
					...
					echo '<td>'.number_format((float)$row['temp'], 2, '.', ' ').'</td>'; //brak danych tlenku
					echo '</tr>';
					}
					echo '</table>';
			...
			<div id="timer"></div>
			<div style="clear:both;" ></div>
			<div class="description">Wykres zmian ilości tlenku azotu w powietrzu przez ostatnią godzine: </div>
			<div class="graph">
				<div class="label">Tlenek azotu [ug/m<sup>3</sup>]</div>
